...
// Make CRM_ConfigProfiles_ExtensionUtil available.
require_once __DIR__ . '/../../config_profiles.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('config-profiles');
 ...
 */
function _config_profiles_test_civicrm_container(ContainerBuilder $container): void {
}
